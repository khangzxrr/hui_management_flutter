...
class PaymentModel {
  ...
  PaymentModel({required this.id, required this.owner, required this.createAt, required this.paymentTransactions, required this.fundBills, required this.status});
