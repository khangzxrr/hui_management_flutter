    ...
    List<PlutoRow> rows = fundBills.map((fb) {
      return PlutoRow(
        cells: {
          ...
          'takeFromFundMemberPrice': PlutoCell(value: (fb.fromSessionDetail.type != NormalSessionDetailType.taken && fb.fromSessionDetail.type != NormalSessionDetailType.emergencyTaken) ? '${Utils.moneyFormat.format(fb.fromSessionDetail.payCost)}đ' : ''),
          'takeFromOwnerPrice': PlutoCell(value: (fb.fromSessionDetail.type == NormalSessionDetailType.taken || fb.fromSessionDetail.type == NormalSessionDetailType.emergencyTaken) ? '${Utils.moneyFormat.format(fb.fromSessionDetail.payCost)}đ' : ''),
