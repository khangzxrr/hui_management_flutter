                ...
                pw.SizedBox(
                  ...
                  child: pw.GridView(
                    ...
                    children: [
                      ...
                      gridTile(pw.Text(Utils.dateFormat.format(fund.openDate), style: pw.TextStyle(font: boldFont), textAlign: pw.TextAlign.right)),
                ...
                pw.SizedBox(
                  ...
                  child: pw.GridView(
                    ...
                    children: [
                      ...
                      gridTile(pw.Text(Utils.dateFormat.format(fundSession.takenDate.toLocal()), style: pw.TextStyle(font: boldFont), textAlign: pw.TextAlign.right)),
